...
<template>
  <div class="relative">
    ...
    <Transition>
      <div
        v-if="toggled"
        class="absolute left-1/2 top-16 z-50 grid w-[30rem] -translate-x-1/2 transform grid-cols-2 gap-4 rounded-lg border border-zinc-300 bg-white px-4 py-2 shadow-lg md:grid-cols-3"
      >
        <div
